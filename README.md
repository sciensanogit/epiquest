...
- <a href="articles/getting-started.html" class="btn btn-primary btn-lg">Get
  started with QUEST</a>

- <a href="articles/dealing-with-new-data.html" class="btn btn-outline-primary btn-lg">Dealing
  with new data</a>
